...
//10. GUARDAR ARCHIVOS .CSV: Se deberá guardar en sus respectivos archivos todos los cambios realizados en jugadores
//HECHO
...
//5 LISTADOS B) TODAS LAS SELECCIONES. [hacer pensar]C) JUGADORES CONVOCADOS (únicamente).
//HECHO
int controller_listarSelecciones(LinkedList* pArrayListSeleccion);

int controller_ordenarSelecciones(LinkedList* pArrayListSeleccion);
//10. GUARDAR ARCHIVOS .CSV: Se deberá guardar en sus respectivos archivos todos los cambios realizados en  selecciones
//HECHO OK
